...
const studies = [
  ...
  { panel: document.getElementById('bamboo-panel'), host: document.getElementById('bamboo-host'), id: 'bamboo-frame', src: '../bamboo/?v=tabs-4', title: 'Move the bamboo up and down to pour water' },
  { panel: document.getElementById('water-3d-panel'), host: document.getElementById('water-3d-host'), id: 'water-3d-frame', src: '../bamboo-3d/?v=tabs-4', title: 'Interactive 3D tipping bamboo fountain with Splash liquid physics' },
];
